...
public class ProductionProvider extends ContentProvider {
	...
	// Le Mime de notre content provider, la premiére partie est toujours identique 
		...
		db.execSQL("CREATE TABLE " + ProductionProvider.CONTENT_PROVIDER_TABLE_NAME + " (" 
			...
			+ Fil.ACCESSOIRE_CABLAGE1 + " STRING,"
			+ Fil.ACCESSOIRE_CABLAGE2 + " STRING,"
			+ Fil.BORNE2_ACCESSOIRE_CABLAGE1 + " FLOAT,"
			+ Fil.BORNE2_ACCESSOIRE_CABLAGE2 + " FLOAT,"
			+ Fil.BORNE_ACCESSOIRE_CABLAGE1 + " FLOAT,"
			+ Fil.BORNE_ACCESSOIRE_CABLAGE2 + " FLOAT,"
			...
			+ Fil.NUMERO_CONNECTEUR_ABOUTISSANT + " STRING,"
			+ Fil.NUMERO_CONNECTEUR_TENANT + " STRING,"
