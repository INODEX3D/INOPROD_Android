...
public class KittingCablesComposants extends Activity {
	...
	private int[] layouts = new int[] { R.id.numeroCable, R.id.typeCable, R.id.designation
			, R.id.referenceFabricant, R.id.referenceInterne, R.id.quantite, R.id.uniteMesure};
	...
	private void displayContentProvider() {
		...
		SimpleCursorAdapter sca = new SimpleCursorAdapter( this, R.layout.grid_layout_kitting_cables_composants, null, columns, layouts);
