...
public class FinalisationTa extends Activity {
	...
	private String columnsNom[] = new String[] { Cable.DESIGNATION_COMPOSANT,
			Cable.REFERENCE_FABRICANT1, Cable.REFERENCE_INTERNE,
		...
		// Récupération des éléments
			...
			private void displayContentProvider() {
				...
				SimpleCursorAdapter sca = new SimpleCursorAdapter(this,
						R.layout.grid_layout_finalisation_ta, null,
						null, layouts);
