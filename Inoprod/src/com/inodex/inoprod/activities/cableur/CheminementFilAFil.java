...
import com.inodex.inoprod.activities.LoginProfil;
...
public class CheminementFilAFil extends Activity {
	...
	private int layouts[] = new int[] { R.id.numeroRevisionLiaison,
			R.id.numeroFilCable, R.id.typeCable, R.id.numeroSegregation,
			R.id.connecteurAboutissant, R.id.zoneLocalisation,
			R.id.nombreSection, R.id.localisationZonePose,
			R.id.nombreFilsArrivantTb };

	private String columnsRac[] = new String[] {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_cheminement_fil_afil);
	...
	private void displayContentProvider() {
		...
		SimpleCursorAdapter sca = new SimpleCursorAdapter(this,
				R.layout.grid_layout_cheminement_ta, null, null, layouts);
	...
	public void onActivityResult(int requestCode, int resultCode, Intent intent) {
		if (requestCode == 0) {
			if (resultCode == RESULT_OK) {
				...
				Toast.makeText(CheminementFilAFil.this,
